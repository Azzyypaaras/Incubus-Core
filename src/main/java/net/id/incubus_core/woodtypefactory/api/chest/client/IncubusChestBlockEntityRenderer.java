...
public final class IncubusChestBlockEntityRenderer implements BlockEntityRenderer<ChestBlockEntity>{
    ...
    public IncubusChestBlockEntityRenderer(BlockEntityRendererFactory.Context ctx, IncubusChestTexture textures){
